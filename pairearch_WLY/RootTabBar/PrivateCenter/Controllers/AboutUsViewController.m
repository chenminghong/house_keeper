...
#define kAboutWLY @"关于SCMC："
#define kAboutWLYContent @"我来运定位于优化运输行业运作，提升资源匹配效率，为货运行业双方提供信息和交易的平台，通过平台对运输各方的认证，保证运输双方的利益。"
...
- (void)viewDidLoad {
    ...
    aboutWLY.font = [UIFont boldSystemFontOfSize:16.0];
    [aboutWLY sizeToFit];
    ...
    [aboutWLYContent mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(aboutWLY.mas_bottom).with.offset(5 * kHeightProportion);
    ...
    aboutShangHaiPaireach.font = [UIFont boldSystemFontOfSize:16.0];
    ...
    [aboutShangHaiPaireachContent mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(aboutShangHaiPaireach.mas_bottom).with.offset(5 * kHeightProportion);
        make.left.equalTo(weakSelf.view.mas_left).with.offset(10);
        make.right.equalTo(weakSelf.view.mas_right).with.offset(-10);
